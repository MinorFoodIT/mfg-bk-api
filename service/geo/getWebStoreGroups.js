  ...
  soap.createClient(url ,{
    ...
    strictSSL: false
      ...
      if(err){
        ...
        client.GetWebStoreGroups(args, function(err1, result) {
          console.log('GetWebStoreGroups');
          
          if(!result.GetWebStoreGroupsResult){
            cb(err1,result.SDKResult);
          }else{
            cb(err1,result.GetWebStoreGroupsResult);
          }
        });  
      }
  });
